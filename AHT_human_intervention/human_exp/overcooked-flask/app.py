...
from AHT_human_intervention.human_exp.agent_pool import AHT_human_intervention_AgentPool
from AHT_human_intervention.human_exp.overcooked_utils import (
    NAME_TRANSLATION,
...
def get_args() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--population_yml_path",
        type=str,
        default=os.getenv("POPULATION_YML_PATH", "./AHT_human_intervention/human_exp/configs/benchmark_configs"),
    ...
    parser.add_argument(
        "--trajs_save_path",
        type=str,
        default=os.getenv("TRAJs_SAVE_PATH", "./AHT_human_intervention/human_exp/data/trajs"),
        help="optional trajectory save path",
    )
    parser.add_argument(
        "--progress_save_path",
        type=str,
        default=os.getenv("PROGRESS_SAVE_PATH", "./AHT_human_intervention/human_exp/data/progress.json"),
        help="optional game progress save path",
    )
    parser.add_argument(
        "--questionnaire_save_path",
        type=str,
        default=os.getenv("QUESTIONNAIRE_SAVE_PATH", "./AHT_human_intervention/human_exp/data/questionnaires"),
...
def main(args: argparse.Namespace):
    ...
    AGENT_POOLS = {
        layout: AHT_human_intervention_AgentPool(
