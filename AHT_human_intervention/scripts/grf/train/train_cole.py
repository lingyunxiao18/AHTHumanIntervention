...
from AHT_human_intervention.envs.grf.grf_env import FootballEnv
from AHT_human_intervention.envs.wrappers.env_policy import PartialPolicyEnv
from AHT_human_intervention.grf_config import get_grf_args
...
def main(args):
    ...
    if all_args.share_policy:
        from AHT_human_intervention.runner.shared.grf_runner import GRFRunner as Runner
    else:
        raise NotImplementedError
