...
from AHT_human_intervention.utils.separated_buffer import SeparatedReplayBuffer
...
def make_trainer_policy_cls(algorithm_name, use_single_network=False):
    algorithm_dict = {
        "rmappo": (
            "AHT_human_intervention.algorithms.r_mappo.r_mappo.R_MAPPO",
            "AHT_human_intervention.algorithms.r_mappo.algorithm.rMAPPOPolicy.R_MAPPOPolicy",
        ),
        "mappo": (
            "AHT_human_intervention.algorithms.r_mappo.r_mappo.R_MAPPO",
            "AHT_human_intervention.algorithms.r_mappo.algorithm.rMAPPOPolicy.R_MAPPOPolicy",
        ...
        "e3t": (
            "AHT_human_intervention.algorithms.r_mappo.r_mappo_target.R_MAPPO_Target",
            "AHT_human_intervention.algorithms.r_mappo.algorithm.rMAPPOPolicy_epsilon.R_MAPPOPolicy_Epsilon",
        ),
        "population": (
            "AHT_human_intervention.algorithms.population.trainer_pool.TrainerPool",
            "AHT_human_intervention.algorithms.population.policy_pool.PolicyPool",
        ),
        "mep": (
            "AHT_human_intervention.algorithms.population.mep.MEP_Trainer",
            "AHT_human_intervention.algorithms.population.policy_pool.PolicyPool",
        ),
        "adaptive": (
            "AHT_human_intervention.algorithms.population.mep.MEP_Trainer",
        ...
        "traj": (
            "AHT_human_intervention.algorithms.population.traj.Traj_Trainer",
            "AHT_human_intervention.algorithms.population.policy_pool.PolicyPool",
        ),
    }
