...
from AHT_human_intervention.config import get_config
from AHT_human_intervention.envs.env_wrappers import (
    ChooseDummyVecEnv,
    ShareDummyVecEnv,
    ShareSubprocDummyBatchVecEnv,
)
from AHT_human_intervention.envs.overcooked.Overcooked_Env import Overcooked
from AHT_human_intervention.envs.overcooked_new.Overcooked_Env import Overcooked as Overcooked_new
from AHT_human_intervention.envs.wrappers.env_policy import PartialPolicyEnv
from AHT_human_intervention.overcooked_config import get_overcooked_args
from AHT_human_intervention.utils.train_util import get_base_run_dir, setup_seed
...
def parse_args(args, parser):
    ...
    from AHT_human_intervention.overcooked_config import OLD_LAYOUTS
...
def main(args):
    ...
    if all_args.share_policy:
        from AHT_human_intervention.runner.shared.overcooked_runner import OvercookedRunner as Runner
    else:
        from AHT_human_intervention.runner.separated.overcooked_runner import (
