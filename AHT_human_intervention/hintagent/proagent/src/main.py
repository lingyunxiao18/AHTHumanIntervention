...
print('\n----Using shared Overcooked-AI (repo version)----\n')
...
from shared.envs.envs.overcooked.overcooked_ai_py.agents.agent import AgentGroup
from shared.envs.envs.overcooked.overcooked_ai_py.mdp.actions import Action
...
def main(variant):
    ...
    # Always use shared Overcooked layouts
    ...
    for i in range(episode):  
        ...
        if mode == 'exp':
            for t in range(horizon):
                ...
                # Shared Overcooked state may not expose medium-level actions; guard access
...
if __name__ == '__main__':
    ...
    parser.add_argument('--gpt_model', type=str, default='gpt-3.5-turbo-0301', choices=['text-davinci-003', 'gpt-3.5-turbo-16k', 'gpt-3.5-turbo-0301', 'gpt-3.5-turbo', 'gpt-4', 'gpt-4-0314', 'gpt-4.1-nano', 'gpt-4o-mini'], help='Number of episodes')
