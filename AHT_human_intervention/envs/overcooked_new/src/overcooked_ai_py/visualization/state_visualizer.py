...
from AHT_human_intervention.envs.overcooked_new.src.overcooked_ai_py.static import (
    FONTS_DIR,
    GRAPHICS_DIR,
)
...
from AHT_human_intervention.envs.overcooked_new.src.overcooked_ai_py.visualization.pygame_utils import (
...
from AHT_human_intervention.envs.overcooked_new.src.overcooked_ai_py.visualization.visualization_utils import (
