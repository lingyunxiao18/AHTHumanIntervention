...
from shared.envs.envs.overcooked.overcooked_ai_py.mdp.layout_generator import (
    COUNTER,
    DISH_DISPENSER,
    EMPTY,
    ONION_DISPENSER,
...
from shared.envs.envs.overcooked.overcooked_ai_py.static import FONTS_DIR, GRAPHICS_DIR
from shared.envs.envs.overcooked.overcooked_ai_py.utils import (
    cumulative_rewards_from_rew_list,
    generate_temporary_file_path,
)
from shared.envs.envs.overcooked.overcooked_ai_py.visualization.pygame_utils import (
...
from shared.envs.envs.overcooked.overcooked_ai_py.visualization.visualization_utils import (
